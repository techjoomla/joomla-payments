...
<form action="<?php echo $vars->url; ?>" name="adminForm" id="adminForm" onSubmit="return myValidate(this);" class="form-validate form-horizontal"  method="post">
	<div>
		<div class="form-group">
			<label for="cardfname" class="col-sm-3 col-xs-12 control-label"><?php  echo Text::_( 'PLG_CHEQUE_ORDER_INFO' );?></label>
			<div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">	<?php  echo Text::sprintf( 'ORDER_INFO', $vars->custom_name);?></div>
		</div>
		<?php $acc_nm =  $vars->acc_holder_name;
		  if(!empty($acc_nm))
		  { ?>
		<div class="form-group">
			<label for="cardfname" class="col-sm-3 col-xs-12 control-label"><?php echo Text::_( 'PLG_CHEQUE_ACC_HOLDER_NAME' ); ?></label>
		...
		<?php $acc_dtl =  $vars->acc_details;
		  ...
		  { ?>
		<div class="form-group">
			<label for="cardlname" class="col-sm-3 col-xs-12 control-label"><?php echo Text::_( 'PLG_ACC_DETAILS' ); ?></label>
		...
		<?php } ?>
		<div class="form-group">
			<label for="cardlname" class="col-sm-3 col-xs-12 control-label"><?php echo Text::_( 'COMMENT' ); ?></label>
			<div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
		...
		<div class="form-group">
			<label for="cardaddress1" class="col-sm-3 col-xs-12 control-label"><?php echo Text::_( 'CON_PAY_PRO' ) ?></label>
			...
			<div class="form-actions">
				...
				<input type='submit' name='btn_check' id='btn_check' class="btn btn-success"  value="<?php echo Text::_('SUBMIT'); ?>">
			</div>
		</div>
	</form>
</div>
