		...
		<div>
			...
			<div id="tj_payGway_billInfo" style="display:<?php echo $plg_billStyle; ?>">
				<div class="control-group">
					<label for="cardfname" class="control-label">
						<?php echo JText::_('FIRST_NAME').JText::_('PLG_AUTHONET_STAR'); ?>
					</label>
					<div class="controls">
				...
				<div class="control-group">
					<label for="cardlname" class="control-label">
						<?php echo JText::_('LAST_NAME').JText::_('PLG_AUTHONET_STAR'); ?>
					</label>
				...
				<div class="control-group">
					<label for="cardaddress1" class="control-label">
						<?php echo JText::_('STREET_ADDRESS').JText::_('PLG_AUTHONET_STAR'); ?>
					</label>
					<div class="controls">
				...
				<div class="control-group">
					<label for="cardcity" class="control-label">
						<?php echo JText::_('CITY').JText::_('PLG_AUTHONET_STAR'); ?>
					</label>
					<div class="controls">
				...
				<div class="control-group">
					<label for="cardstate" class="control-label">
						<?php echo JText::_('STATE').JText::_('PLG_AUTHONET_STAR'); ?>
					</label>
					<div class="controls">
				...
				<div class="control-group">
					<label for="cardzip" class="control-label">
						<?php echo JText::_('POSTAL_CODE').JText::_('PLG_AUTHONET_STAR'); ?>
					</label>
					<div class="controls">
				...
				<div class="control-group">
					<label for="cardcountry" class="control-label">
						<?php echo JText::_('COUNTRY').JText::_('PLG_AUTHONET_STAR'); ?>
					</label>
					<div class="controls">
				...
				<div class="control-group">
					<label for="email" class="control-label">
						<?php echo JText::_('EMAIL_ADDRESS').JText::_('PLG_AUTHONET_STAR'); ?>
					</label>
					<div class="controls">
			...
			<div class="control-group">
				<label for="cardnum" class="control-label">
					<?php echo JText::_('CARD_NUMBER').JText::_('PLG_AUTHONET_STAR'); ?>
				</label>
				<div class="controls">
			...
			<div class="control-group">
				<label for="cardexp" class="control-label">
					<?php echo JText::_('EXPIRATION_DATE_IN_FORMAT_MMYY').JText::_('PLG_AUTHONET_STAR'); ?>
				</label>
				<div class="controls">
			...
			<div class="control-group">
				<label for="cardcvv" class="control-label">
					<?php echo JText::_('CARD_CVV_NUMBER').JText::_('PLG_AUTHONET_STAR'); ?>
				</label>
				<div class="controls">
