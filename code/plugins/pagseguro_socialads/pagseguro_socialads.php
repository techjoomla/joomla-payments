...
class  plgPaymentPagseguro_socialads extends CMSPlugin
{
...
*/
  ...
  'ERROR'  => 'E',
	...
	function onTP_GetHTML($vars)
	{
		...
		$vars->action_url = plgPaymentPagseguro_socialadsHelper::buildPagseguroUrl($vars,1);
	...
	function onTP_Processpayment($data,$vars=array()) 
	{
		...
		$vars->sellar_email = $this->params->get('sellar_email');
		$vars->token = $this->params->get('token');
		$verified_Data = plgPaymentPagseguro_socialadsHelper::validateIPN($data,$vars);
