...
class FormFieldAupfilesjticketing extends FormField
{
	...
	protected function getInput()
	{
		...
		{
			$html = '<div style="float:left"><a href="' . JURI::root() . 'plugins/payment/altauserpoints/altauserpoints/jticketing_aup.zip"> '
			. Text::_('AUP_CLK') . '</a><span> ' . Text::_('AUP_INST') . ' </span><a href="' . JURI::base()
			. 'index.php?option=com_altauserpoints&task=plugins" target="_blank">' . Text::_('HERE')
