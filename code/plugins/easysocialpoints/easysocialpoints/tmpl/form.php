...
<form action="<?php echo $vars->url ?>" class="form-validate form-horizontal"  method="post" id="paymentForm" name="paymentForm">
		<div>
			<div>
				<div class="controls">
				<?php echo Text::sprintf( 'PLG_EASYSOCIALPOINT_CONVERSION_RATE_MESSAGE', $vars->convert_val, $vars->currency_code);?>
				</div>
		</div>
		...
		<div >
			<div class="controls">
			 ...
			 echo Text::sprintf( 'PLG_EASYSOCIALPOINT_TOTAL_POINTS_NEEDED_MESSAGE', $charge_points);?>
			</div>
		</div>
		...
		<div >
			<div class="controls">
				<?php
						 echo Text::sprintf( 'PLG_EASYSOCIALPOINT_CURRENT_POINTS_SITUATION', $vars->user_points);?>
			</div>
		</div>


		<?php $not_enough_pts_message="'".Text::_('PLG_EASYSOCIALPOINT_NOT_ENOUGH_POINTS_MESSAGE')."'";
			/*if(!empty($vars->success_message))
			$success_message="'".$vars->success_message."'";
			else*/
			$success_message="'".Text::sprintf( 'PLG_EASYSOCIALPOINT_TOTAL_POINTS_DEDUCTED_MESSAGE',$charge_points)."'";
		?>

		<div class="form-actions">
			<input name="submit" class="btn btn-success btn-large pull-right" id="js_buy" type="button" value="<?php echo Text::_('PLG_EASYSOCIALPOINT_SUBMIT');?>" onclick="calculate(<?php echo $vars->convert_val;?>,<?php echo $vars->amount;?>,<?php echo $vars->user_points;?>,<?php echo $not_enough_pts_message; ?>,<?php echo $success_message; ?>);">
