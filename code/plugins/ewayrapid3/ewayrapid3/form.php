...
?>
<h3><?php echo Text::_('PLG_PAYMENT_EWAYRAPID3_FORM_HEADER') ?></h3>
<p align="center">
<form id="payment-form" action="<?php echo htmlentities($vars->submiturl) ?>" class="form-horizontal" method="post">
	...
	<div class="control-group" id="control-group-card-holder">
		<label for="card-holder" class="control-label" style="width:190px; margin-right:20px;">
			<?php echo Text::_('PLG_PAYMENT_EWAYRAPID3_FORM_CARDHOLDER') ?>
		</label>
		<div class="controls">
			<input type="text" name="EWAY_CARDNAME" id="EWAY_CARDNAME" class="input-large" value="<?php echo $result->Customer->FirstName . ' ' . $result->Customer->LastName ?>" />
		</div>
	</div>
	<div class="control-group" id="control-group-card-number">
		<label for="card-number" class="control-label" style="width:190px; margin-right:20px;">
			<?php echo Text::_('PLG_PAYMENT_EWAYRAPID3_FORM_CC') ?>
		</label>
		<div class="controls">
	...
	<div class="control-group" id="control-group-card-expiry">
		<label for="card-expiry" class="control-label" style="width:190px; margin-right:20px;">
			<?php echo Text::_('PLG_PAYMENT_EWAYRAPID3_FORM_EXPDATE') ?>
		</label>
		<div class="controls">
	...
	<div class="control-group" id="control-group-card-cvc">
		<label for="card-cvc" class="control-label" style="width:190px; margin-right:20px;">
			<?php echo Text::_('PLG_PAYMENT_EWAYRAPID3_FORM_CVC') ?>
		</label>
		<div class="controls">
