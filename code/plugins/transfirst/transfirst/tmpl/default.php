...
<form action="<?php echo $vars->url; ?>" name="adminForm" id="adminForm" onSubmit="return myValidate(this);"  enctype="multipart/form-data" class="form-validate form-horizontal"  method="post">
	<div>
		<div class="control-group">
			<label for="card_num" class="control-label"><?php echo Text::_( 'PLG_TRANSFIRST_CARD_NUMBER' ) ?></label>
			<div class="controls">
		...
		<div class="control-group">
			<label for="card_type" class="control-label"><?php echo Text::_( 'PLG_TRANSFIRST_CARD_TYPE' ) ?></label>
			<div class="controls">
		...
		<div class="control-group">
			<label for="" class="control-label"><?php echo Text::_( 'PLG_TRANSFIRST_CREDIT_CARD_TYPE' ) ?></label>
		...
		<div class="control-group">
			<label for="cardlname" class="control-label"><?php echo Text::_( 'PLG_TRANSFIRST_EXPIRATION_DATE_IN_FORMAT_MMYY' ) ?></label>
			<div class="controls">
						<?php
							$all[0]=new stdClass;
							$all[0]->value = '';
		...
		<div class="control-group">
			<label for="cardfname" class="control-label"><?php echo Text::_( 'PLG_TRANSFIRST_CVV_CODE' ) ?></label>
