...
onSubmit="return myValidate(this);">
	<div>
		...
		<div class="form-group">
			<label for="creditcard_name" class="col-lg-2 col-md-2 col-sm-3 col-xs-12 control-label"><?php echo JText::_('Name On Card'); ?></label>
			<div class="col-lg-10 col-md-10 col-sm-9 col-xs-12">	<input type="text" name="creditcard_name"
			id="creditcard_name" size="25" class="inputbox required" value="" />
			</div>
		</div>
