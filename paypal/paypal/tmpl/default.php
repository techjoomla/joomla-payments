	...
	<tr>
		<td class="title">
			<form action="<?php echo $vars->action_url ?>" method="post">			
				...
				<input type="submit" class="button" src="https://www.paypal.com/en_US/i/btn/x-click-but02.gif" border="0" value="Pay Now" alt="Make payments with PayPal - it's fast, free and secure!" />
